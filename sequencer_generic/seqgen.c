...
void main(void)
{
    ...
    syslog(LOG_CRIT, "RTES: Sequencer @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec - start_time_val.tv_sec), (int)current_time_val.tv_usec / USEC_PER_MSEC);
...
{
    struct timeval current_time_val;
    struct timespec delay_time = {0, 66666666}; // delay for 66.66 msec, 60 Hz
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "RTES: Sequencer thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec - start_time_val.tv_sec), (int)current_time_val.tv_usec / USEC_PER_MSEC);
    ...
    do
    {
        ...
        // gettimeofday(&current_time_val, (struct timezone *)0);
        // syslog(LOG_CRIT, "RTES: Sequencer thread prior to delay @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec/USEC_PER_MSEC);
        do
        {
        ...
        seqCnt++;
        gettimeofday(&current_time_val, (struct timezone *)0);
        syslog(LOG_CRIT, "RTES: Sequencer cycle %llu @ sec=%d, msec=%d\n", seqCnt, (int)(current_time_val.tv_sec - start_time_val.tv_sec), (int)current_time_val.tv_usec / USEC_PER_MSEC);
        ...
        // gettimeofday(&current_time_val, (struct timezone *)0);
        // syslog(LOG_CRIT, "RTES: Sequencer release all sub-services @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec/USEC_PER_MSEC);
...
{    
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "RTES: S1 Frame Sampler thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec - start_time_val.tv_sec), (int)current_time_val.tv_usec / USEC_PER_MSEC);
...
void *Service_2(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "RTES: S2 Time-stamp with Image Analysis thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec - start_time_val.tv_sec), (int)current_time_val.tv_usec / USEC_PER_MSEC);
...
void *Service_3(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "RTES: S3 Difference Image Proc thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec - start_time_val.tv_sec), (int)current_time_val.tv_usec / USEC_PER_MSEC);
...
void *Service_4(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "RTES: Time-stamp Image Save to File thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec - start_time_val.tv_sec), (int)current_time_val.tv_usec / USEC_PER_MSEC);
...
void *Service_5(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "RTES: Processed Image Save to File thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec - start_time_val.tv_sec), (int)current_time_val.tv_usec / USEC_PER_MSEC);
...
void *Service_6(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "RTES: Send Time-stamped Image to Remote thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec - start_time_val.tv_sec), (int)current_time_val.tv_usec / USEC_PER_MSEC);
...
void *Service_7(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "RTES: 10 sec Tick Debug thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec - start_time_val.tv_sec), (int)current_time_val.tv_usec / USEC_PER_MSEC);
