...
static void dump_ppm(const void *p, int size, unsigned int tag, struct timespec *time)
{
    ...
    snprintf(&ppm_dumpname[24], "%05d", (int)time->tv_sec);
    snprintf(&ppm_dumpname[33], "%05d", (int)((time->tv_nsec) / 1000000));
    strncat(&ppm_dumpname[37], ".ppm", 5);
...
static void dump_pgm(const void *p, int size, unsigned int tag, struct timespec *time)
{
    ...
    snprintf(&pgm_dumpname[24], "%05d", (int)time->tv_sec);
    snprintf(&pgm_dumpname[33], "%05d", (int)((time->tv_nsec) / 1000000));
    strncat(&pgm_dumpname[37], ".pgm", 5);
